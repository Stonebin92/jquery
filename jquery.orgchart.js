...
(function($) {
  ...
  function buildHierarchy ($appendTo, nodeData, level, opts, callback) {
    ...
    if (hasChildren) {
      ...
      $table.append('<tr class="lines' + isHidden + '"><td colspan="' + $childNodes.length * 2 + '"><div class="downline"></div></td></tr>');
      // draw the lines close to children nodes
      var linesRow = '<tr class="lines' + isHidden + '"><td class="rightline">&nbsp;</td>';
      for (var i=1; i<$childNodes.length; i++) {
        linesRow += '<td class="leftline topline">&nbsp;</td><td class="rightline topline">&nbsp;</td>';
      }
      linesRow += '<td class="leftline">&nbsp;</td></tr>';
